app = (function () {
  ...
  class Seat {
	...
	function getMousePosition() {
		console.info("entre al getmouse");
	        if (va == null) {
	            Swal.fire({
					  icon: 'error',
	...
	function calcularAsiento(x1, y1) {
		...
		for (i of va.seats){
			...
			for (j of i){
				c++;
				console.info("x1= "+x1+" y1= "+y1+" x= "+x+" y= "+y);
